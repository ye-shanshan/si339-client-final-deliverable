...
"""
        ...
        index_name = "meets/index.html"
        index_file = make_index()
        index_file = re.sub(r'<time>', '<span class="time">', index_file)
        index_file = re.sub(r'</time>', '</span>', index_file)
        with open(index_name, 'w', encoding='utf-8') as indexfile:
            indexfile.write(index_file)
        print(f"HTML file '{index_name}' created successfully.")
